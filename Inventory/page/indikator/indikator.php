...
<!-- desember -->
                      ...
                      <td>
                      <a href="?page=indikator&aksi=ubahindikator&id=<?php echo $data['id'] ?>" class="btn btn-success" > <i class="fas fa-pen"></i> </a>
                      <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="?page=indikator&aksi=hapusindikator&id=<?php echo $data['id'] ?>" class="btn btn-danger" > <i class="fas fa-trash"></i> </a>
                      </td>
                                        </tr>
                  <?php }?>
                ...
                <a href="?page=indikator&aksi=tambahindikator" class="btn btn-primary" >Tambah</a>
                  </tbody>
                </table>
              </div>
            </div>
