...
<!-- desember -->
                      ...
                      <td>
                      <a href="?page=matlevkam&aksi=ubahkam&id=<?php echo $data['id'] ?>" class="btn btn-success" > <i class="fas fa-pen"></i> </a>
                      <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="?page=matlevkam&aksi=hapuskam&id=<?php echo $data['id'] ?>" class="btn btn-danger" > <i class="fas fa-trash"></i> </a>
                      </td>
                                        </tr>
                  <?php }?>
                ...
                <a href="?page=matlevkam&aksi=tambahkam" class="btn btn-primary" >Tambah</a>
                  </tbody>
                </table>
              </div>
            </div>
