  <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">TAMBAH BOSQUE K3L</h5>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                            ...
                            <div class="form-group">
                               <div class="form-line">
                             <input type="text" name="zero_accident" class="form-control" />
							</div>
                            </div>
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="pic_bosque" class="form-control" />	 
							</div>
                            </div>
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="satuan_bosque" class="form-control" />
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="target_bosque" class="form-control" />	 
							</div>
                            </div>
...
<!-- januari -->
              ...
              <label for="">JANUARI_MG-1_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JANUARI_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JANUARI_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JANUARI_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JANUARI_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jan_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- februari -->
              ...
              <label for="">FEBRUARI_MG-1_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">FEBRUARI_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">FEBRUARI_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">FEBRUARI_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">FEBRUARI_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="feb_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- maret -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MARET_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MARET_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MARET_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MARET_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mar_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- april -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">APRIL_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">APRIL_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">APRIL_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">APRIL_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="apr_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- mei -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MEI_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MEI_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MEI_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">MEI_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="mei_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- juni -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JUNI_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JUNI_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JUNI_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JUNI_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jun_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- juli -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JULI_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JULI_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JULI_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">JULI_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jul_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- agustus -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">AGUSTUS_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">AGUSTUS_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">AGUSTUS_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">AGUSTUS_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="agu_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- september -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">SEPTEMBER_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">SEPTEMBER_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">SEPTEMBER_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">SEPTEMBER_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="sep_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- oktober -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">OKTOBER_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">OKTOBER_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">OKTOBER_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">OKTOBER_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="okt_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- november -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">NOVEMBER_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">NOVEMBER_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">NOVEMBER_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">NOVEMBER_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="nov_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- desember -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">DESEMBER_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">DESEMBER_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">DESEMBER_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">DESEMBER_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="des_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- total -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">TOTAL_MG-2_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_target_2" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_real_2" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">TOTAL_MG-3_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_target_3" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_real_3" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">TOTAL_MG-4_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_target_4" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_real_4" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">TOTAL_MG-5_TARGET</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_target_5" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="total_real_5" class="form-control" />	 
							</div>
                            </div>
...
<!-- total tahun -->
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="tahun_target_1" class="form-control" />	 
							</div>
                            </div>              
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="tahun_real_1" class="form-control" />	 
							</div>
                            </div>
              ...
              <label for="">TAHUN_REAL_2</label>
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="tahun_real_2" class="form-control" />	 
							</div>
                            </div>              
